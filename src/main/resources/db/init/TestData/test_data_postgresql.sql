...
INSERT INTO hospital_department (id, hospital_id, department_name, parent_department_name, department_intro, service_scope, active_status, deleted, gender_rule, age_min, age_max, crowd_tags_json, standard_dept_code, subspecialty_code, district_name, latitude, longitude, is_emergency, national_key_score, provincial_key_score, city_key_score, authority_score) VALUES
-- 北京协和医院
(1,  'HOSP_001', '心血管内科', '内科', '国家级重点学科，擅长各类心血管疾病的诊治', '冠心病、高血压、心力衰竭、心律失常等', 1, 0, 'all', 0, 200, '["老年人","慢性病"]',         'STD_CARD',   'SUB_CARD_INTERV',   '东城区', 39.9145, 116.4074, 1, 95.00, 98.00, 100.00, 97.50),
(2,  'HOSP_001', '神经内科',   '内科', '全国领先的神经系统疾病诊疗中心',           '脑卒中、癫痫、帕金森病、神经免疫疾病等', 1, 0, 'all', 0, 200, '["老年人","脑卒中高危"]',   'STD_NEURO',  'SUB_NEURO_CEREB',   '东城区', 39.9145, 116.4074, 1, 93.00, 96.00, 100.00, 95.00),
(3,  'HOSP_001', '骨科',       '外科', '骨科疑难重症诊疗中心',                     '关节置换、脊柱外科、创伤骨科、运动医学等', 1, 0, 'all', 18, 200, '["老年人","骨质疏松"]',     'STD_ORTHO',  'SUB_ORTHO_JOINT',   '东城区', 39.9145, 116.4074, 0, 90.00, 94.00, 100.00, 93.00),
(4,  'HOSP_001', '内分泌科',   '内科', '糖尿病与代谢疾病综合诊疗中心',              '糖尿病、甲状腺疾病、肥胖症等',           1, 0, 'all', 0, 200, '["糖尿病","代谢综合征"]',   'STD_ENDO',   'SUB_ENDO_DIAB',     '东城区', 39.9145, 116.4074, 0, 88.00, 92.00, 100.00, 91.00),
(5,  'HOSP_001', '妇产科',     '妇产科', '妇产科疾病综合诊疗中心',                  '妇科肿瘤、产科、生殖内分泌等',           1, 0, 'female', 18, 100, '["女性"]',                 'STD_OBGY',   'SUB_OBGY_GYNONC',   '东城区', 39.9145, 116.4074, 1, 85.00, 90.00, 100.00, 88.00),
-- 瑞金医院
(6,  'HOSP_002', '心血管内科', '内科', '心血管疾病国家重点学科',                  '高血压、冠心病、心肌病等',               1, 0, 'all', 0, 200, '["老年人","慢性病"]',         'STD_CARD',   'SUB_CARD_HTN',      '黄浦区', 31.2304, 121.4737, 1, 92.00, 96.00, 100.00, 95.00),
(7,  'HOSP_002', '呼吸内科',   '内科', '呼吸系统疾病国家重点学科',                  '慢阻肺、哮喘、肺部感染等',               1, 0, 'all', 0, 200, '["吸烟者","老年人"]',       'STD_RESPI',  'SUB_RESPI_COPD',    '黄浦区', 31.2304, 121.4737, 0, 88.00, 93.00, 100.00, 92.00),
(8,  'HOSP_002', '消化内科',   '内科', '消化系统疾病诊疗中心',                     '胃炎、肝硬化、消化道肿瘤等',             1, 0, 'all', 0, 200, '["慢性病","中老年人"]',     'STD_GASTRO', 'SUB_GASTRO_LIVER',  '黄浦区', 31.2304, 121.4737, 0, 86.00, 90.00, 100.00, 89.00),
(9,  'HOSP_002', '皮肤科',     '皮肤科', '皮肤疾病专科',                           '湿疹、银屑病、痤疮等',                   1, 0, 'all', 0, 200, NULL,                       'STD_DERM',   'SUB_DERM_ECZEMA',   '黄浦区', 31.2304, 121.4737, 0, 80.00, 85.00, 100.00, 83.00),
(10, 'HOSP_002', '儿科',       '儿科', '儿童疾病综合诊疗中心',                     '儿童呼吸、消化、生长发育等',             1, 0, 'all', 0, 14,  '["儿童"]',                 'STD_PED',    'SUB_PED_GROWTH',    '黄浦区', 31.2304, 121.4737, 1, 82.00, 88.00, 100.00, 86.00),
-- 中山一院
(11, 'HOSP_003', '神经内科',   '内科', '华南地区神经系统疾病诊疗中心',             '脑卒中、帕金森、神经免疫等',             1, 0, 'all', 0, 200, '["老年人","脑卒中高危"]',   'STD_NEURO',  'SUB_NEURO_PARK',    '越秀区', 23.1291, 113.2644, 1, 90.00, 94.00, 100.00, 93.00),
(12, 'HOSP_003', '肾内科',     '内科', '肾脏疾病重点学科',                         '肾小球肾炎、肾功能不全、透析等',         1, 0, 'all', 0, 200, '["慢性肾病","糖尿病"]',     'STD_NEPHRO', 'SUB_NEPHRO_CKD',    '越秀区', 23.1291, 113.2644, 0, 85.00, 90.00, 100.00, 90.00),
(13, 'HOSP_003', '普通外科',   '外科', '普外科疾病诊疗中心',                       '胆囊结石、阑尾炎、疝气等',               1, 0, 'all', 0, 200, NULL,                       'STD_GENSURG','SUB_GENSURG_GALL',  '越秀区', 23.1291, 113.2644, 1, 82.00, 87.00, 100.00, 85.00),
(14, 'HOSP_003', '眼科',       '眼科', '眼科疾病诊疗中心',                         '白内障、青光眼、眼底病等',               1, 0, 'all', 0, 200, '["老年人"]',               'STD_OPHTH',  'SUB_OPHTH_CATARACT','越秀区', 23.1291, 113.2644, 0, 78.00, 84.00, 100.00, 82.00),
-- 华西医院
(15, 'HOSP_004', '呼吸内科',   '内科', '全国呼吸疾病重点学科',                     '慢阻肺、哮喘、间质性肺病等',             1, 0, 'all', 0, 200, '["吸烟者","老年人"]',       'STD_RESPI',  'SUB_RESPI_ASTHMA',  '武侯区', 30.6394, 104.0668, 0, 94.00, 98.00, 100.00, 96.00),
(16, 'HOSP_004', '风湿免疫科', '内科', '西南地区风湿免疫疾病中心',                 '类风湿关节炎、狼疮、强直性脊柱炎等',     1, 0, 'all', 0, 200, '["中老年人","女性"]',       'STD_RHEUM',  'SUB_RHEUM_RA',      '武侯区', 30.6394, 104.0668, 0, 88.00, 92.00, 100.00, 91.00),
(17, 'HOSP_004', '泌尿外科',   '外科', '泌尿系统疾病诊疗中心',                     '前列腺增生、泌尿系结石、肿瘤等',         1, 0, 'male', 18, 200, '["中老年男性"]',           'STD_URO',    'SUB_URO_BPH',       '武侯区', 30.6394, 104.0668, 0, 84.00, 89.00, 100.00, 87.00),
(18, 'HOSP_004', '精神心理科', '精神科', '心理健康诊疗中心',                       '抑郁症、焦虑症、睡眠障碍等',             1, 0, 'all', 12, 200, '["青少年","职场人群"]',     'STD_PSYCH',  'SUB_PSYCH_DEPRESS', '武侯区', 30.6394, 104.0668, 0, 80.00, 85.00, 100.00, 83.00),
-- 同济医院
(19, 'HOSP_005', '心血管内科', '内科', '中部地区心血管疾病诊疗中心',               '冠心病、高血压、心力衰竭等',             1, 0, 'all', 0, 200, '["老年人","慢性病"]',         'STD_CARD',   'SUB_CARD_CAD',      '硚口区', 30.5801, 114.2631, 1, 89.00, 93.00, 100.00, 92.00),
(20, 'HOSP_005', '耳鼻喉科',   '五官科', '耳鼻喉疾病专科',                         '过敏性鼻炎、中耳炎、喉部疾病等',         1, 0, 'all', 0, 200, NULL,                       'STD_ENT',    'SUB_ENT_RHINITIS',  '硚口区', 30.5801, 114.2631, 0, 76.00, 82.00, 100.00, 80.00),
(21, 'HOSP_005', '骨科',       '外科', '骨科疾病诊疗中心',                         '脊柱外科、关节置换、运动创伤等',         1, 0, 'all', 0, 200, '["老年人","骨质疏松"]',     'STD_ORTHO',  'SUB_ORTHO_SPINE',   '硚口区', 30.5801, 114.2631, 0, 85.00, 90.00, 100.00, 89.00),
(22, 'HOSP_005', '内分泌科',   '内科', '内分泌代谢疾病中心',                       '糖尿病、甲状腺、骨质疏松等',             1, 0, 'all', 0, 200, '["糖尿病","代谢综合征"]',   'STD_ENDO',   'SUB_ENDO_OSTEO',    '硚口区', 30.5801, 114.2631, 0, 83.00, 88.00, 100.00, 86.00),
-- 海淀医院
(23, 'HOSP_006', '心血管内科', '内科', '心血管疾病专科',                           '高血压、冠心病等常见病诊治',             1, 0, 'all', 0, 200, '["老年人","慢性病"]',         'STD_CARD',   NULL,                '海淀区', 39.9641, 116.2981, 1, 0, 65.00, 100.00, 70.00),
(24, 'HOSP_006', '儿科',       '儿科', '儿童常见病诊疗',                           '儿童感冒、肺炎、生长发育评估等',         1, 0, 'all', 0, 14,  '["儿童"]',                 'STD_PED',    NULL,                '海淀区', 39.9641, 116.2981, 0, 0, 60.00, 100.00, 65.00),
-- 浦东新区人民医院
(25, 'HOSP_007', '妇产科',     '妇产科', '妇产科常见病诊疗',                       '产检、妇科炎症、子宫肌瘤等',             1, 0, 'female', 18, 100, '["女性"]',                 'STD_OBGY',   NULL,                '浦东新区', 31.2309, 121.5457, 1, 0, 55.00, 100.00, 60.00),
(26, 'HOSP_007', '急诊科',     '急诊科', '急诊抢救中心',                           '各类急危重症的初步处理',                 1, 0, 'all', 0, 200, NULL,                       'STD_EMERG',  NULL,                '浦东新区', 31.2309, 121.5457, 1, 0, 70.00, 100.00, 75.00),
-- 白云区第二人民医院
(27, 'HOSP_008', '消化内科',   '内科', '消化系统疾病专科',                         '胃病、肠炎、肝炎等常见病诊治',           1, 0, 'all', 0, 200, NULL,                       'STD_GASTRO', NULL,                '白云区', 23.1642, 113.2492, 0, 0, 50.00, 100.00, 55.00),
(28, 'HOSP_008', '口腔科',     '口腔科', '口腔疾病专科门诊',                       '龋齿、牙周病、口腔正畸等',               1, 0, 'all', 0, 200, NULL,                       'STD_DENT',   NULL,                '白云区', 23.1642, 113.2492, 0, 0, 45.00, 100.00, 50.00),
(29, 'HOSP_008', '皮肤科',     '皮肤科', '皮肤常见病门诊',                         '湿疹、荨麻疹、痤疮等',                   1, 0, 'all', 0, 200, '["中老年人","女性"]',       'STD_DERM',   NULL,                '白云区', 23.1642, 113.2492, 0, 0, 48.00, 100.00, 52.00),
(30, 'HOSP_008', '骨科',       '外科', '骨科常见病专科',                           '骨质疏松、骨折、颈肩腰腿痛等',           1, 0, 'all', 0, 200, '["老年人","骨质疏松"]',     'STD_ORTHO',  NULL,                '白云区', 23.1642, 113.2492, 0, 0, 52.00, 100.00, 58.00);
SELECT setval('hospital_department_id_seq', 30);

-- ========================== DISEASE MASTER 病种表 (25条)
INSERT INTO disease_master (id, disease_code, disease_name, aliases_json, symptom_keywords, gender_rule, age_min, age_max, age_group, urgency_level, review_status, deleted) VALUES
(1,  'DIS_001', '原发性高血压',           '["高血压","高血压病","HTN"]',                         '头晕,头痛,心悸,眼花,耳鸣',                                 'all',    18, 200, 'adult',    'medium', 'approved', 0),
(2,  'DIS_002', '2型糖尿病',               '["糖尿病","II型糖尿病","T2DM"]',                       '多饮,多尿,多食,体重下降,乏力',                              'all',    18, 200, 'adult',    'medium', 'approved', 0),
(3,  'DIS_003', '冠状动脉粥样硬化性心脏病', '["冠心病","冠脉粥样硬化","CAD","缺血性心脏病"]',      '胸痛,胸闷,心悸,气短,放射痛',                                'all',    40, 200, 'elder',    'high',   'approved', 0),
(4,  'DIS_004', '脑梗死',                   '["脑卒中","中风","缺血性卒中","脑梗塞"]',             '突发偏瘫,口眼歪斜,言语不清,肢体麻木,头晕',                  'all',    50, 200, 'elder',    'critical','approved', 0),
(5,  'DIS_005', '社区获得性肺炎',           '["肺炎","CAP","肺部感染"]',                           '发热,咳嗽,咳痰,胸痛,呼吸困难',                              'all',    0,  200, 'all',      'high',   'approved', 0),
(6,  'DIS_006', '支气管哮喘',               '["哮喘","过敏性哮喘"]',                               '喘息,呼吸困难,咳嗽,胸闷,夜间加重',                          'all',    0,  200, 'all',      'high',   'approved', 0),
(7,  'DIS_007', '慢性胃炎',                 '["胃炎","慢性浅表性胃炎","胃病"]',                    '上腹痛,腹胀,嗳气,反酸,恶心',                                'all',    18, 200, 'adult',    'low',    'approved', 0),
(8,  'DIS_008', '肝硬化',                   '["肝纤维化","代偿期肝硬化","失代偿期肝硬化"]',         '乏力,腹胀,黄疸,蜘蛛痣,肝掌',                                'all',    30, 200, 'adult',    'high',   'approved', 0),
(9,  'DIS_009', '慢性肾功能不全',           '["慢性肾病","CKD","肾功能衰竭"]',                      '乏力,水肿,尿少,食欲不振,恶心',                              'all',    30, 200, 'adult',    'high',   'approved', 0),
(10, 'DIS_010', '甲状腺功能亢进症',         '["甲亢","Graves病"]',                                 '心悸,手抖,多汗,体重下降,突眼,易激动',                       'all',    18, 100, 'adult',    'medium', 'approved', 0),
(11, 'DIS_011', '类风湿关节炎',             '["类风湿","RA"]',                                     '关节肿痛,晨僵,对称性关节炎,关节畸形',                       'all',    30, 150, 'adult',    'medium', 'approved', 0),
(12, 'DIS_012', '骨质疏松症',               '["骨质疏松","骨量减少"]',                             '骨痛,易骨折,身高变矮,驼背',                                 'all',    50, 200, 'elder',    'medium', 'approved', 0),
(13, 'DIS_013', '抑郁症',                   '["抑郁","MDD","抑郁障碍"]',                           '情绪低落,兴趣减退,睡眠障碍,食欲下降,疲乏',                  'all',    12, 200, 'all',      'medium', 'approved', 0),
(14, 'DIS_014', '湿疹',                     '["特应性皮炎","皮肤湿疹"]',                           '皮肤瘙痒,红斑,丘疹,水疱,脱屑',                              'all',    0,  200, 'all',      'low',    'approved', 0),
(15, 'DIS_015', '过敏性鼻炎',               '["变应性鼻炎","鼻敏感","AR"]',                        '鼻塞,流涕,喷嚏,鼻痒,眼痒',                                  'all',    0,  200, 'all',      'low',    'approved', 0),
(16, 'DIS_016', '急性阑尾炎',               '["阑尾炎","盲肠炎"]',                                 '右下腹痛,恶心,呕吐,发热,麦氏点压痛',                        'all',    5,  200, 'all',      'critical','approved', 0),
(17, 'DIS_017', '胆囊结石',                 '["胆结石","胆囊结石伴胆囊炎"]',                       '右上腹痛,恶心,呕吐,黄疸,油腻食物后加重',                    'all',    18, 200, 'adult',    'high',   'approved', 0),
(18, 'DIS_018', '前列腺增生',               '["BPH","前列腺肥大"]',                                '尿频,尿急,夜尿增多,排尿困难,尿流变细',                      'male',   50, 200, 'elder',    'medium', 'approved', 0),
(19, 'DIS_019', '子宫肌瘤',                 '["子宫平滑肌瘤"]',                                   '月经量增多,经期延长,下腹包块,压迫症状,贫血',                 'female', 20, 60,  'adult',    'medium', 'approved', 0),
(20, 'DIS_020', '白内障',                   '["老年性白内障"]',                                   '视力下降,视物模糊,眼前黑影,眩光',                           'all',    50, 200, 'elder',    'medium', 'approved', 0),
(21, 'DIS_021', '帕金森病',                 '["帕金森","PD","震颤麻痹"]',                          '静止性震颤,肌强直,运动迟缓,姿势步态异常',                   'all',    50, 200, 'elder',    'medium', 'approved', 0),
(22, 'DIS_022', '银屑病',                   '["牛皮癣","银屑病关节炎"]',                           '皮肤红斑,鳞屑,瘙痒,关节痛,指甲改变',                        'all',    0,  200, 'all',      'medium', 'approved', 0),
(23, 'DIS_023', '痛风',                     '["高尿酸血症","痛风性关节炎"]',                       '关节剧痛,红肿,发热,第一跖趾关节,夜间发作',                  'all',    18, 200, 'adult',    'high',   'approved', 0),
(24, 'DIS_024', '焦虑症',                   '["广泛性焦虑","GAD","焦虑障碍"]',                     '紧张不安,心悸,出汗,睡眠困难,注意力不集中',                  'all',    12, 200, 'all',      'medium', 'approved', 0),
(25, 'DIS_025', '腰椎间盘突出症',           '["腰间盘突出","腰椎间盘脱出","坐骨神经痛"]',          '腰痛,下肢放射痛,麻木,肌力下降,直腿抬高试验阳性',            'all',    18, 200, 'adult',    'medium', 'approved', 0);
...
INSERT INTO import_review_item (id, job_id, dataset_type, item_key, issue_type, raw_content, suggestion, resolved, resolution_note) VALUES
(1, 2, 'DISEASE',    'DIS_MIGRAINE',  'AMBIGUOUS_NAME', '{"disease_name":"偏头痛","aliases":["头疼"]}',  '别名"头疼"范围过宽，建议改为"偏侧头痛"', 0, NULL),
(2, 2, 'DISEASE',    'DIS_IRON_DEF',  'MISSING_FIELD',  '{"disease_name":"缺铁性贫血","age_min":null}',  '建议补充适用年龄范围',                    1, '已补充：age_min=0, age_max=200'),
(3, 3, 'DOCTOR',     'DOC_ZHANG_SAN', 'UNCERTAIN_TITLE', '{"doctor_name":"张三","title":"主治/副主任（待确认）"}', '职称信息不明确，请确认实际职称',           0, NULL),
(4, 3, 'DOCTOR',     'DOC_LI_SI',     'UNCERTAIN_DEPT',  '{"doctor_name":"李四","department":"综合科"}',          '"综合科"跨度较大，建议细化至具体专科',     1, '已确认为心内科'),
(5, 4, 'DEPARTMENT', 'DEPT_GERIATRIC','NEW_ENTRY',       '{"department_name":"老年病科","hospital":"华山医院"}',   '标准库中暂无对应编码，建议新建 STD_GERIATRIC', 0, NULL),
(6, 4, 'DEPARTMENT', 'DEPT_PAIN',     'NEW_ENTRY',       '{"department_name":"疼痛科","hospital":"瑞金医院"}',     '标准库中暂无对应编码，建议新建 STD_PAIN',       0, NULL);
