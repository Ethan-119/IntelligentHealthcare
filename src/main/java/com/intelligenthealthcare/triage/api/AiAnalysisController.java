...
public class AiAnalysisController {
    ...
    public AiSessionSummaryResponse createSession(@CurrentPatient PatientAuthPrincipal principal) {
        AiSessionSummary summary = aiAnalysisService.createSession(principal);
        return AiSessionSummaryResponse.builder()
                .sessionId(summary.sessionId())
                .title(summary.title())
                .askRound(summary.askRound())
    ...
    public void deleteSession(
        ...
        aiAnalysisService.deleteSession(principal, sessionId);
    }
